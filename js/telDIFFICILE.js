        ...
        for(let j=0; j<nMatx; j++){
            switch(matrice[i][j]){
                case -4:
                    ...
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+7, (i*pixelCasella)+5);
                    ctx.lineTo((j*pixelCasella)+20, (i*pixelCasella)+12);
                    ctx.lineTo((j*pixelCasella)+7, (i*pixelCasella)+20);
                    ctx.closePath();
                    ctx.fillStyle = 'red';
                    ctx.fill();
                    break
                ...
                case 4:
                    ...
                    ctx.beginPath();
                    ctx.arc((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2), 9, 0, 2 * Math.PI);
                    ctx.fillStyle = 'black';
                    ctx.fill();
                    ...
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+5, (i*pixelCasella)+5);
                    ctx.stroke();
                    
                    // Spikes - top right
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+25, (i*pixelCasella)+5);
                    ctx.stroke();
                    
                    // Spikes - bottom left
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+5, (i*pixelCasella)+25);
                    ctx.stroke();
                    
                    // Spikes - bottom right
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+25, (i*pixelCasella)+25);
                    ctx.stroke();
                    break
                    ...
                    if(bombe[i][j]!=0){
                        switch(bombe[i][j]){
                            case 1:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "blue"
                                ctx.fillText("1",(j*pixelCasella)+8, (i*pixelCasella)+24)
                                break

                            case 2:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "green"
                                ctx.fillText("2", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break
                            
                            case 3:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "red"
                                ctx.fillText("3", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break
                            
                            case 4:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "#483D8B"
                                ctx.fillText("4", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break
                            
                            case 5:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "orange"
                                ctx.fillText("5", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break

                            case 6:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "yellow"
                                ctx.fillText("6",(j*pixelCasella)+8, (i*pixelCasella)+24)
                                break

                            case 7:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "#4682B4"
                                ctx.fillText("7", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break

                            case 8:
                                ctx.font = "25px arial"
                                ctx.fillStyle = "black"
                                ctx.fillText("8", (j*pixelCasella)+8, (i*pixelCasella)+24)
                                break
                        }
                    }
                    break
...
let nBandiere = 40 //proporzionale al campo minato di google
