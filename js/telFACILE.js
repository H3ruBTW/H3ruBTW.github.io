        ...
        for(let j=0; j<nMatx; j++){
            switch(matrice[i][j]){
                ...
                case 1:
                    ...
                    ctx.fillRect((j*pixelCasella)+7, (i*pixelCasella)+7, 31, 31)
                ...
                case 4:
                    ...
                    ctx.beginPath();
                    ctx.arc((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2), 13, 0, 2 * Math.PI);
                    ctx.fillStyle = 'black';
                    ctx.fill();
                    ...
                    ctx.lineTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+3);
                    ctx.stroke();
                    
                    // Spikes - bottom
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+42);
                    ctx.stroke();
                    
                    // Spikes - left
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+3, (i*pixelCasella)+(pixelCasella/2));
                    ctx.stroke();
                    
                    // Spikes - right
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+42, (i*pixelCasella)+(pixelCasella/2));
                    ctx.stroke();
                    
                    // Spikes - top left
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+8, (i*pixelCasella)+8);
                    ctx.stroke();
                    
                    // Spikes - top right
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+37, (i*pixelCasella)+8);
                    ctx.stroke();
                    
                    // Spikes - bottom left
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+8, (i*pixelCasella)+37);
                    ctx.stroke();
                    
                    // Spikes - bottom right
                    ctx.beginPath();
                    ctx.moveTo((j*pixelCasella)+(pixelCasella/2), (i*pixelCasella)+(pixelCasella/2));
                    ctx.lineTo((j*pixelCasella)+37, (i*pixelCasella)+37);
                    ctx.stroke();
                    break
                    ...
                    if(bombe[i][j]!=0){
                        switch(bombe[i][j]){
                            case 1:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "blue"
                                ctx.fillText("1", (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break

                            case 2:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "green"
                                ctx.fillText("2",  (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break
                            
                            case 3:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "red"
                                ctx.fillText("3",  (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break
                            
                            case 4:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "#483D8B"
                                ctx.fillText("4",  (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break
                            
                            case 5:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "orange"
                                ctx.fillText("5",  (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break

                            case 6:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "yellow"
                                ctx.fillText("6", (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break

                            case 7:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "#4682B4"
                                ctx.fillText("7",  (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break

                            case 8:
                                ctx.font = "35px arial"
                                ctx.fillStyle = "black"
                                ctx.fillText("8", (j*pixelCasella)+12, (i*pixelCasella)+35)
                                break
                        }
                    }
                    break
...
let nBandiere = 12 //proporzionale al campo minato di google
